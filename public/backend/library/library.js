        ...
        if ($('.changeStatusAll').length) {
            $(document).on('click', '.changeStatusAll', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(res) {
                        if (res.flag == true) {
                            let cssActive1 = 'box-shadow: rgb(100, 189, 99) 0px 0px 0px 16px inset; border-color: rgb(100, 189, 99); background-color: rgb(100, 189, 99); transition: border 0.4s ease 0s, box-shadow 0.4s ease 0s, background-color 1.2s ease 0s;';
